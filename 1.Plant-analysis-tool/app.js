...
app.post("/analyze", upload.single("image"), async (req, res) => {
  try {
    ...
    const results = await model.generateContent([
      "Analyzing this plant image and provide detailed analysis of its species, health, and care recommendations, its characteristics, care instruction, and any interesting facts. Please provide the response in plain text value without using any markdown formatting",
      {
        inlineData: {
